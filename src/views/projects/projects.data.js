export const PROJECT_DATA = {
    genid: {
        ...
        details: 'Genid is a simple CLI application that generates Random IDs , the IDs are guaranteed to be universally unique and can be in both numeric or alphanumeric.',
    ...
    'home-automation': {
        ...
        details: 'The api is built to work with TP-Link Smart devices, the goal was for this microservice is so I can build a control panel for my house.',
        techDetails: 'The Microservice was built using NodeJS and ExpressJS, a MongoDB instance is used to store details of devices and states.'
    },
    rewrite: {
    ...
    'ne-weather': {
        ...
        links: [],
        details: 'This is my second year undergrad group software engineering project. NE Weather is a location based weather app that provides users event suggestions based on the current weather and air pollution conditions. ' +
    ...
    anomify: {
        ...
        links: [],
        details: 'This project is my first introduction to web development. Previously my projects did not require any real backend services, the main purpose of this project is to learn about building backend services.',
        techDetails: 'I used a very standard LAMP stack. the site is written in PHP with a MySQL database and deployed on an Apache server.'
    }
};