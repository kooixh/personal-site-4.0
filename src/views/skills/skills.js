    ...
    return (
        <div>
            ...
            <p>
                ...
                go to
                programming language is Java because of my experience with it, but I am also fluent in multiple
                languages.
            </p>
            <p>
                Spring Boot, Express and Flask are the web server framework I have the most experience with. Outside of
                backend
                development I have done projects on Mobile App development in Native Android as well as hybrid framework
                like
                Ionic.
            </p>
            <p>
...
function renderTechPreference() {
    ...
    TECH_PREF.forEach((elem) => {
        preferences.push(
            <TechPreference name={elem.name} emoji={elem.emoji} emojiLabel={elem.emojiLabel}/>
        );
    });
    return preferences;
}
    ...
    return (
        <div className="devHistory pb-5">
            ...
            <p className="mt-3">
                ...
                Being the
                only tech enthusiast in the house, I found myself needing to search to internet to solve a lot of tech
                problems,
                like how to install the latest version of Windows, how to download a Torrent, etc. From there I
                gradually gained
            ...
            <p>
                ...
                further
                by creating a simple web browser and a statistic calculator, which built my interest in programming. I
                then went
            ...
            <p>
                ...
                messaging
                sites, budget tracking mobile app, etc. I really like the feeling of developing a piece of software that
                is
